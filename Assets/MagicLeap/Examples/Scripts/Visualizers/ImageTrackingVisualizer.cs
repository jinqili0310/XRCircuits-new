...
namespace MagicLeap
{
    ...
    public class ImageTrackingVisualizer : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("Game Object showing the help video")]
        public GameObject _videoHelp = null;
        ...
        void Awake()
        {
            ...
            if (null == _videoHelp)
            {
                Debug.LogError("Error: ImageTrackingVisualizer._videoHelp is not set, disabling script.");
                enabled = false;
                return;
            }
            if (null == _menu)
        ...
        private void RefreshConfiguration()
        {
            switch (_lastConfiguration)
            {
                ...
                case ImageTrackingExample.ConfigurationStatus.Configuration3:
                    ...
                    break;
               // case ImageTrackingExample.ConfigurationStatus.HelpVideo:
                  //  _diagramBase.SetActive(_targetFound);
                  //  _diagramConf1.SetActive(false);
                  //  _diagramConf2.SetActive(false);
                  //  _diagramConf3.SetActive(false);
                 ...
                 //   _videoConf1.SetActive(false);
                 //   _videoConf2.SetActive(false);
                 //   _videoHelp.SetActive(_targetFound);
                 //   _videoConf3.SetActive(false);
                 //   break;
            }
        }
